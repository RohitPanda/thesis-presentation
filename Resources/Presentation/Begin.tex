...
\newcommand{\PraesentationTitelseiteInhalt}{
    \begin{textblock*}{\paperwidth}[0,0](0cm,-\PraesentationSeitenrand - 6.5mm + \PraesentationPositionKorrekturOben)%
        \color{PraesentationTextfarbe}
        \frametitle{\\\vspace{1cm}\inserttitle}
        \vspace*{49.4mm}
        \usebeamerfont{author}\selectfont\vspace{2cm}\insertauthor\\
        %\insertinstitute\\
        \vspace{4cm}
        \insertdate%
    \end{textblock*}
...
\newcommand{\PraesentationStartseiteUhrenturm}{
    \setbeamertemplate{title page}{%
        \PraesentationSeitenkopfInhalt{./Resources/_Images/Universitaet_Logo_RGB.pdf}
...
\newcommand{\PraesentationStartseiteFlaggen}{
    \setbeamertemplate{title page}{%
        ...
        \end{textblock*}
        \PraesentationSeitenkopfInhalt{./Resources/_Images/Universitaet_Logo_weiss.pdf}
        \PraesentationTitelseiteInhalt
    }
}
